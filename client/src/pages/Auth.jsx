...
//                         Continue with
//                         <span className='bg-green-200 text-gray-700 px-3 py-1 rounded-full inline-flex items-center gap-2'>
//                             <IoSparkles size={16}/>
//                             Smart AI Interview
//                         </span>
//                     </h1>
...
function Auth({isModel = false}) {
  ...
  return (
    ...
    `}>
        ...
        className={`
        w-full 
        ${isModel ? "max-w-md p-8 rounded-3xl" : "max-w-lg p-12 rounded-lg"}
